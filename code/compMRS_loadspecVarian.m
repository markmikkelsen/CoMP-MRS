%compMRS_loadspecVarian.m
%based on io_loadspec_varian.m
%Jamie Near, McGill University 2014
%Diana Rotaru, Medical University of Vienna, 2025
%
% USAGE:
% [out]=compMRS_loadspecVarian(filename);
% 
% DESCRIPTION:
% Reads in varian .fid data using the readfid.m and readprocpar.m functions 
% from Martyn Klassen (mklassen@robarts.ca).
% 
% This function outputs the data in structure format, with fields corresponding to time
...
function out=compMRS_loadspecVarian(filename)
