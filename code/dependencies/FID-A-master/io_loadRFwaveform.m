...
%             also be the name of a two, three or four column matlab array 
...
jumps=diff(rf(:,1));
jumpsAbs=(abs(jumps)>340 & abs(jumps)<380);  %Assume jumps within this range are exactly = 360 degrees.
