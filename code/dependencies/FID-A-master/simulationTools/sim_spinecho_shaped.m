...
% 
% USAGE:
% sim_spinecho_shaped(n,sw,Bfield,linewidth,sys,TE,RF,Tp,grad,pos,ph, shape)
% 
% DESCRIPTION:
...
% shape      = the lineshape of the simulation ('L' for Lorentzian, 'G' for Gaussian)
%
% OUTPUTS:
...
function out = sim_spinecho_shaped(n,sw,Bfield,linewidth,sys,TE,RF,Tp,grad,pos,ph,flipAngle,centreFreq,shape)
...
d=sim_shapedRF(d,H,RF,Tp,flipAngle,90+ph,pos,grad);   %shaped 180 degree refocusing pulse about y' axis.
d=sim_evolve(d,H,delay/2000);                      %Evolve by delay/2
[out,dout]=sim_readout(d,H,n,sw,linewidth,90,shape);  %Readout along y (90 degree phase);
%END PULSE SEQUENCE**************
