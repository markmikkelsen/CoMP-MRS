...
% 
% USAGE:
% [h,freq]=op_getPeakHeight(in,NAAppmmin,NAAppmmax);
% 
% DESCRIPTION:
...
% freq           = Frequency of max peak intensity

function [h,freq]=op_getPeakHeight(in,NAAppmmin,NAAppmmax);
