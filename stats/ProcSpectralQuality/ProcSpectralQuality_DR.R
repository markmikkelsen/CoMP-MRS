...
fixed_effects <- list(
  M.2 = c("FieldStrength", "Age", "Sex"),
  M.2.a = c("FieldStrength"),
  M.2.b = c("Age"),
  M.2.c = c("Sex")
)
...
model_contrasts <- list(
  small_models = c("M.0.a", "M.0.b", "M.0.a", "M.0.a"),
  large_models = c("M.0.d", "M.0.d", "M.1.c", "M.1.e")
  #small_models = c("M.0.a", "M.0.b", "M.0.a", "M.0.a", "M.1.c"),
  #large_models = c("M.0.d", "M.0.d", "M.1.c", "M.1.e", "M.2")
  #small_models = c("M.0.a", "M.0.b", "M.0.c", "M.0.c", "M.1.e"),
