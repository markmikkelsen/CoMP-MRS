...
# Y.M.SNRLWrationorm.0.0 <- lm(SNR_LW_Ratio_norm ~ 1, data=DATA)
Y.M.SNRLWrationorm.0.1 <- lmer(cs.(SNR_LW_Ratio_norm) ~ (1 | DP), data = DATA, REML = FALSE, control = optimToUse)
# Y.M.SNRLWrationorm.0.2 <- lmer(SNR_LW_Ratio_norm ~ (1 | MRvendor), data = DATA, REML = FALSE, control = optimToUse)
# Y.M.SNRLWrationorm.0.3 <- lmer(SNR_LW_Ratio_norm ~ (1 | SiteID), data = DATA, REML = FALSE, control = optimToUse)
# Y.M.SNRLWrationorm.0.4 <- lmer(SNR_LW_Ratio_norm ~ (1 | MRvendor) + (1 | SiteID) , data = DATA, REML = FALSE, control = optimToUse)
Y.M.SNRLWrationorm.0.5 <- lmer(cs.(SNR_LW_Ratio_norm) ~ (1 | MRvendor) + (1 | SiteID) + (1 | DP),
                data = DATA, REML = FALSE, control = optimToUse)
Y.M.SNRLWrationorm.1.0 <- lmer(SNR_LW_Ratio_norm ~ (1 | MRvendor) + (1 | SiteID) + (1 | DP) + 
                   (1 | AnimalSpecies) , data = DATA, REML = FALSE, control = optimToUse)
Y.M.SNRLWrationorm.2.0 <- lmer(SNR_LW_Ratio_norm ~ (1 | MRvendor) + (1 | SiteID) + (1 | DP) +
                   (1 | AnimalSpecies) + (1 | MRbrainregion) , data = DATA, REML = FALSE, control = optimToUse)
Y.M.SNRLWrationorm.3.0 <- lmer(SNR_LW_Ratio_norm ~ (1 | MRvendor) + (1 | SiteID) + (1 | DP) +
                   (1 | AnimalSpecies) + (1 | MRbrainregion) + (1 | MRsequence) , data = DATA, REML = FALSE, control = optimToUse)
Y.M.SNRLWrationorm.4.0 <- lmer(SNR_LW_Ratio_norm ~ MRfield + (1 | MRvendor) + (1 | SiteID) + (1 | DP) +
                   (1 | AnimalSpecies) + (1 | MRbrainregion) + (1 | MRsequence) , data = DATA, REML = FALSE, control = optimToUse)
Y.M.SNRLWrationorm.5.0 <- lmer(SNR_LW_Ratio_norm ~ MRfield + AnimalAge + (1 | MRvendor) + (1 | SiteID) + (1 | DP) +
                   (1 | AnimalSpecies) + (1 | MRbrainregion) + (1 | MRsequence) , data = DATA, REML = FALSE, control = optimToUse)
Y.M.SNRLWrationorm.6.0 <- lmer(SNR_LW_Ratio_norm ~ MRfield + AnimalAge + AnimalSex + (1 | MRvendor) + (1 | SiteID) + (1 | DP) +
                   (1 | AnimalSpecies) + (1 | MRbrainregion) + (1 | MRsequence) , data = DATA, REML = FALSE, control = optimToUse)


### Model diagnostics ---------------------------------------------------------

# dotplot(ranef(Y.M.SNRLWrationorm.0.1, condVar=TRUE), scales=list(relation="free"))
# dotplot(ranef(Y.M.SNRLWrationorm.0.5, condVar=TRUE), scales=list(relation="free"))
# dotplot(ranef(Y.M.SNRLWrationorm.1.0, condVar=TRUE), scales=list(relation="free"))
# dotplot(ranef(Y.M.SNRLWrationorm.2.0, condVar=TRUE), scales=list(relation="free"))
# dotplot(ranef(Y.M.SNRLWrationorm.3.0, condVar=TRUE), scales=list(relation="free"))
# dotplot(ranef(Y.M.SNRLWrationorm.4.0, condVar=TRUE), scales=list(relation="free"))
# dotplot(ranef(Y.M.SNRLWrationorm.5.0, condVar=TRUE), scales=list(relation="free"))
# dotplot(ranef(Y.M.SNRLWrationorm.6.0, condVar=TRUE), scales=list(relation="free"))

# check_model(Y.M.SNRLWrationorm.0.0)
 check_model(Y.M.SNRLWrationorm.0.1)
# check_model(Y.M.SNRLWrationorm.0.5)
# check_model(Y.M.SNRLWrationorm.1.0)
# check_model(Y.M.SNRLWrationorm.2.0)
# check_model(Y.M.SNRLWrationorm.3.0)
# check_model(Y.M.SNRLWrationorm.4.0)
# check_model(Y.M.SNRLWrationorm.5.0)
# check_model(Y.M.SNRLWrationorm.6.0)

model_performance(Y.M.SNRLWrationorm.0.1)
# model_performance(Y.M.SNRLWrationorm.0.5)
# model_performance(Y.M.SNRLWrationorm.1.0)
# model_performance(Y.M.SNRLWrationorm.2.0)
# model_performance(Y.M.SNRLWrationorm.3.0)
# model_performance(Y.M.SNRLWrationorm.4.0)
# model_performance(Y.M.SNRLWrationorm.5.0)
# model_performance(Y.M.SNRLWrationorm.6.0)

# r2(Y.M.SNRLWrationorm.0.1)
# check_model(Y.M.SNRLWrationorm.0.2)
# check_model(Y.M.SNRLWrationorm.0.3)
# check_model(Y.M.SNRLWrationorm.0.4)
# check_model(Y.M.SNRLWrationorm.0.5)
# check_model(Y.M.SNRLWrationorm.1.0)
# check_model(Y.M.SNRLWrationorm.2.0)
# check_model(Y.M.SNRLWrationorm.3.0)
...
# check_model(Y.M.SNRLWrationorm.6.0)
 ...
 z <- profile(Y.M.SNRLWrationorm.0.1)
 z_ci <- confint(z, level=0.95)^2
 xyplot(z, aspect=1)
 plot(Y.M.SNRLWrationorm.0.1)
 hist(resid(Y.M.SNRLWrationorm.0.1))

 # z1 <- profile(Y.M.SNRLWrationorm.1.0)
 # z_ci <- confint(z1, level=0.95)^2
 # xyplot(z1, aspect=1)
 # plot(Y.M.SNRLWrationorm.1.0)
 # hist(resid(Y.M.SNRLWrationorm.1.0))
 # 
 # z2 <- profile(Y.M.SNRLWrationorm.2.0)
 # z_ci <- confint(z2, level=0.95)^2
 # xyplot(z2, aspect=1)
 # plot(Y.M.SNRLWrationorm.2.0)
 # hist(resid(Y.M.SNRLWrationorm.12.0))
 # 
 # z3 <- profile(Y.M.SNRLWrationorm.3.0)
 # z_ci <- confint(z3, level=0.95)^2
 # xyplot(z3, aspect=1)
 # plot(Y.M.SNRLWrationorm.3.0)
 # hist(resid(Y.M.SNRLWrationorm.3.0))
 # 
 # z4 <- profile(Y.M.SNRLWrationorm.4.0)
 # z_ci <- confint(z4, level=0.95)^2
 # xyplot(z4, aspect=1)
 # plot(Y.M.SNRLWrationorm.4.0)
 # hist(resid(Y.M.SNRLWrationorm.4.0))
 # 
 # z5 <- profile(Y.M.SNRLWrationorm.5.0)
 # z_ci <- confint(z5, level=0.95)^2
 # xyplot(z5, aspect=1)
 # plot(Y.M.SNRLWrationorm.5.0)
 # hist(resid(Y.M.SNRLWrationorm.5.0))
 # 
 # z6 <- profile(Y.M.SNRLWrationorm.6.0)
 # z_ci <- confint(z6, level=0.95)^2
 # xyplot(z6, aspect=1)
 # plot(Y.M.SNRLWrationorm.6.0)
 # hist(resid(Y.M.SNRLWrationorm.6.0))


### Variance components -------------------------------------------------------

# Save variance components of three-level null model
# print(VarCorr(Y.M.SNRLWrationorm.0.1), comp = c("Variance", "Std.Dev."))
vc <- as.data.frame(VarCorr(Y.M.SNRLWrationorm.0.1))[4]
vpc.M.0.1 <- round(vc/sum(vc)*100,1)
dimnames(vpc.M.0.1)[[1]] <- c("DP", "Residual")

# print(VarCorr(Y.M.SNRLWrationorm.0.5), comp = c("Variance", "Std.Dev."))
vc <- as.data.frame(VarCorr(Y.M.SNRLWrationorm.0.5))[4]
